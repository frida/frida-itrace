...
export const TRACE_EVENT_COMPILE = 1;
export const TRACE_EVENT_START = 2;
export const TRACE_EVENT_END = 3;
export const TRACE_EVENT_PANIC = 4;
...
function makeBufferReadImpl() {
    const machineCodeTemplate = [
        ...
        0x11, 0x00, 0x00, 0x14, /* b do_memcpy                */
        /* copy_with_wrap:                                    */
        ...
        0xdf, 0x02, 0x14, 0xeb, /* cmp x22, x20               */
        0x96, 0x22, 0x96, 0x9a, /* csel x22, x20, x22, hs     */
